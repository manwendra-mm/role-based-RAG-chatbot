...
# ---------- Configuration ----------
MARKDOWN_DIR = "./DS-RPC-01/data/finance"     # Path to directory containing .md files
CHROMA_DB_DIR = "./finance_chroma_db"         # Where vector DB will be persisted
...
def query_vector_store(vectordb, k):
    ...
    while True:
        print("\n\n----------------------------------------")
        question = input("Ask your question (q to quit): ") #Asking Question from user
        if question.lower() == 'q':
